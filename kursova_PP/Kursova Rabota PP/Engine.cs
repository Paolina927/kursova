                    ...
                    case ("add"):
                        switch (commandParts[1])
                        {
                            case ("galaxy"):
                                ...
                                break;
                            case ("star"):
                                AddStar(commandParts[2], commandParts[3], commandParts[5], commandParts[7], commandParts[4], commandParts[6]);
                                break;
                            case ("planet"):
                                AddPlanet(commandParts[2], commandParts[3], commandParts[5], commandParts[4]);
                                break;
                            case ("moon"):
